...
<section class="content-header">
    ...
    <li><a href="{{route('clientes.clientes.index')}}">Clientes</a></li>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12">
              <div class="form-group">
                <label for="type_user" class="col-xs-12 col-sm-3">Tipo Usuario</label>
                <div class="col-sm-9">
                  <input type="text" id="tpe_user" name="type_user" class="form-control" placeholder="" value="{{$consulta->type_user}}" disabled>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-6 text-sm-right col-md-6 col-lg-1 text-center">
        <a href="{{route('clientes.clientes.edit',['id' => Crypt::encrypt($consulta->id)])}}" class="btn btn-md btn-info">Editar</a>
      </div>
