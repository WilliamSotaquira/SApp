			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<center><a href="{{route('clientes.clientes.create')}}" ><button class="btn btn-success"style="margin-top:6px !important;">Crear Nuevo Registro</button></a></center>
					</div>
					<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
						@include('clientes.clientes.search')
					</div> 
				</div>
					...
					<div class="table-responsive">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$per->mobile}}</td>
								<td>
									<a href="{{route('clientes.clientes.show',['id' => Crypt::encrypt($per->id)])}}" class="btn btn-sm btn-default"> Ver </a>
								</td>
								<td>
									<a href="{{route('clientes.clientes.edit',['id' => Crypt::encrypt($per->id)])}}" class="btn btn-sm btn-info"> Editar </a>
								</td>
								<td>
									<a href="#" data-target=" #modal-delete-{{$per->id}}" data-toggle="modal"><button class="btn btn-sm btn-danger">Eliminar</button></a> 
								</td>
							</tr>
							@include('clientes.clientes.modal')
							@endforeach
						</tbody>
