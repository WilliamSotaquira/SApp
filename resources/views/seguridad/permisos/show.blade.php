 ...
 -->
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12">
        <div class="form-group">
          <label for="updates_at" class="col-xs-12 col-sm-2 control-label">Actualizado</label>
          <div class="col-sm-6">
            <input type="text" name="updates_at" id="updates_at" class="form-control" value="{{$permisos->updates_at}}" placeholder="Sin especificar" disabled="">
          </div>
        </div>
      </div>
    </div>
