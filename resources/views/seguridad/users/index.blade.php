      ...
      <div class="container-fluid">
        ...
        <div class="row mt-1 justify-content-between align-items-center" >
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            @can('users.create')
            <center><a href="{{route ('seguridad.users.create')}}" ><button class="btn btn-success">Crear Nuevo Usuario</button></a></center>
            @endcan
          </div>
          <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
           @include('seguridad.users.search')
         </div> 
       </div>
       <div class="box-body">	
         ...
         <tbody>
          ...
          <tr>
           ...
           <td>
            ...
            {{ $user->document='Sin registro aún'}}
            @else 
            {{ $user->document}}
            @endif            
          ...
          <td>
            <a href="{{route('seguridad.users.show',$user->id)}}" class="btn btn-sm btn-default"> Ver </a>                     
          </td>
          <td>
            @can('users.edit')
            <a href="{{route ('seguridad.users.edit', $user->id )}}" class="btn btn-sm btn-info"> Editar </a>
            @endcan
          </td>
          <td>
