  ...
  <section class="content">
    <div class="error-page">
      ...
      <div class="error-content">
        <h3><i class="fa fa-warning text-red"></i> ¡Oops! Lamentamos el inconveniente, la pagina solicitada se encuentra en temporalmente fuera de servicio.</h3><br>


        <p>
          Si ha perdido alguna función contacte al administrador...<br>
          <a href="{{route('home')}}">O Regrese al escritorio aquí...</a> 
