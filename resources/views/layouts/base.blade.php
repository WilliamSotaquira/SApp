...
<head>
	...
	<link rel="stylesheet" href="{{asset('twbs/bootstrap/dist/css/bootstrap-select.min.css')}}">
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<!-- Limpiar formularios -->
	<script src="{{asset('almasaeed2010/adminlte/bower_components/bootstrap/dist/js/clearForm.js')}}"></script>
	<!-- SlimScroll -->
	...
	<script src="{{asset('twbs/bootstrap/dist/js/bootstrap-select.min.js')}}"></script>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#sandbox-container .input-group.datepicker').datepicker({
				format: "yyyy/mm/dd",
				todayBtn: "linked",
				language: "es",
				...
				autoclose: true,
				todayHighlight: true,
				datesDisabled: ['01/06/2021', '01/21/2021']
