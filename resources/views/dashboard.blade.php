...
<head>
	...
	<!-- CSS ADN -->
	<link rel="stylesheet" type="text/css" href="{{asset ('twbs/bootstrap/dist/css/dashboard_style.css')}}">
	<!-- icon -->
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header red-wdw">

			<!-- Logo -->
			<a href="{{ route('dashboard') }}" class="logo hgray-wdw">
				<!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini hgray-wdw"><img class="responsive  img-fluid mx-auto d-block zoom" src="{{asset ('icons/logo30x18.png')}}"></span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg hgray-wdw"><img class="responsive  img-fluid mx-auto d-block zoom" src="{{asset ('icons/logo_sapp_90X30.png')}}"></span>
			</a>
			<!-- Header Navbar: style can be found in header.less -->
			<nav class="navbar navbar-static-top red-wdw">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<!-- User Account: style can be fond in dropdown.less -->
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="{{asset('user/user160X160.png')}}" class="user-image" alt="">
								<span class="hidden-xs">{{ Auth::user()->name }} {{ Auth::user()->last_name }}</span>
							</a>


							<ul class="dropdown-menu m-5">
								<!-- User image -->
								<li class="user-header">
									<img src="{{asset('user/user160X160.png')}}" class="img-circle" alt="">
								...
								<!-- Menu Footer-->
								<li class="user-footer hgray-wdw">
									<div class="pull-left">
										<a href="#" class="btn btn-default btn-rounded btn-wdw text-light">Profile</a>
									</div>
									<div class="pull-right">

										<a class="btn btn-default btn-rounded btn-wdw text-light" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
											{{ __('Cerrar Sesión') }}
										</a>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Dashboard
					<small>Piensalo, nosotros lo hacemos.</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-xs-6">
								...
								<div class="small-box bg-blue">
									...
									<a href="#" class="small-box-footer">Aquí <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
							...
							<div class="col-lg-6 col-xs-6">
								<!-- small box -->
								<a href="{{route('comercial.cotizaciones.create')}}">
									<div class="small-box bg-yellow">
										<div class="inner">
											<h1 class="display-4">Cotización</h1>
							...
							<div class="col-lg-6 col-xs-6">
								...
								<div class="small-box bg-red">
									...
									<a href="#" class="small-box-footer">Aqui <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
					...
					<div class="col-xs-12 col-sm-7">
						...
						<div class="box">
							...
							<div class="box-footer text-center">
								<a href="javascript:void(0)" class="uppercase">Ver todos los eventos</a>
							</div>
							<!-- /.box-footer -->
						</div>
						<!-- /.box -->
				...
				<div class="row">
					<div class="col-md-8">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Utimos Proyectos</h3>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2020-2022 <a href="https://adminlte.io">weirdoware.com</a>.</strong> All rights
			reserved.
		</footer>
