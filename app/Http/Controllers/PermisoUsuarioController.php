...
/*Request*/
use App\Http\Requests\PermisoUsuarioFormRequest;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public function index(Request $request)
    {
     ...
     ->select('pu.id','u.name as uname','u.last_name','pe.name as pname','pe.slug as pslug','pe.description','pu.created_at','ro.name as rolname')

     ->where('u.name','LIKE','%'.$query.'%')
     ->where('u.last_name','LIKE','%'.$query.'%')
